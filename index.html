...
<head>
    ...
    <title>Khas Untuk Marshanda ❤️</title>
    <style>
        body {
        ...
        .heart-text {
            ...
            opacity: 0;
            transform: translate(-50%, -50%);
            animation: twinkleHeart 3s ease-in-out infinite;
        }

        @keyframes twinkleHeart {
            0% { opacity: 0; transform: translate(-50%, -50%) scale(0.6); }
            50% { opacity: 1; transform: translate(-50%, -50%) scale(1.1); text-shadow: 0 0 5px #ff3366; }
...
<body>
    ...
    <div id="login-container" class="container">
        ...
        <form id="login-form">
            <div class="input-group">
                <label for="username">MASUKKAN NAMA AWAK:</label>
                <input type="text" id="username" name="username" placeholder="Masukkan nama..." autocomplete="off" required>
            </div>
            <div class="input-group">
                <label for="password">CUBA TEKA PASSWORD!!!:</label>
                <input type="password" id="password" name="password" placeholder="••••" required>
            </div>
            <button type="submit">DECRYPT SYSTEM</button>
        </form>
        <p id="message"></p>
    </div>

    <div id="success-container" class="hidden">
        <div id="heart-wrapper"></div>
        <h1 class="main-love-text">Love you, Marshanda.</h1>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const validUsername = 'marshanda'; 
            const validPassword = '140107';      
            ...
            loginForm.addEventListener('submit', (e) => {
                ...
                if (username === validUsername && password === validPassword) {
                    ...
                    message.textContent = 'Cuba lagi, mesti tak ingat kan tarikh lahir hmm..........'; 
                }
            });
            ...
            function generateHeart() {
                ...
                // Formula Auto-scale agar muat di skrin phone & PC secara automatik
